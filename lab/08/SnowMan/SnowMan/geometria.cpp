...
void crea_casa(Mesh* mesh, vec4 color_top, vec4 color_bottom)
{
	// 0
	mesh->vertici.push_back(vec3(2.0, -1.0, 2.0));
	mesh->colori.push_back(color_bottom);
	...
	// 2
	mesh->vertici.push_back(vec3(2.0, 1.0, -2.0));
	mesh->colori.push_back(color_top);
	...
	// 4
	mesh->vertici.push_back(vec3(1.5, 1.5, 0.0));
	mesh->colori.push_back(color_bottom);
