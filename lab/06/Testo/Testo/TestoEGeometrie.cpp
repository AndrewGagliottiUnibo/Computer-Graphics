...
void drawScene(void)
{
	...
	Scena[0].Model = translate(Scena[0].Model, vec3(900.0 + 50 * cos(dx_f), 500.0 + 50 * sin(dx_f), 0.0));
	...
	if (Scena[0].alive == TRUE)
	{
		...
		RenderText(programId_text, Projection, "Game Over", VAO_Text, VBO_Text, 600.0f, 600.0f, 1.0f, glm::vec3(1.0, 1.0f, 0.2f));
	// Scrivere del testo

	RenderText(programId_text, Projection, "Scena Marina", VAO_Text, VBO_Text, 100.0f, 600.0f, 1.0f, glm::vec3(1.0, 1.0f, 0.2f));
	glUseProgram(programId);
